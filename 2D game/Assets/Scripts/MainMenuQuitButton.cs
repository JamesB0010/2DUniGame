...
public class MainMenuQuitButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    //the functionality for when the button is pressed, quit the application
